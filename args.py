...
def _add_common_args(arg_parser):
    ...
    arg_parser.add_argument("--train_path", default="./DiffusionIE_11.21/data/15res", type=str, help="The path of train set.")
    arg_parser.add_argument("--dev_path", default="./DiffusionIE_11.21/data/15res", type=str, help="The path of dev set.")
    arg_parser.add_argument("--test_path", default="./DiffusionIE_11.21/data/15res", type=str, help="The path of dev set.")
    arg_parser.add_argument("--save_dir", default='./DiffusionIE_11.21/checkpoint', type=str,
